...
public class ShowImage
{
	...
	public void run()
	{
		...
		label.setBounds(335,0,  300,100); // Sets location = 335, 0 and size = 300x100
...
class DrawingArea extends JPanel implements MouseListener, KeyListener 
{
	...
	public void paintComponent ( Graphics g ) 
	{
		if ( keyClear ) 
		{
			...
			System.out.println("keyClear is true");
		}
		///////////////////////////////////////////////////////////
	...
	public void keyPressed(KeyEvent evt)
	{
		...
		// Pressing the space or shift keys will clear the screen.
